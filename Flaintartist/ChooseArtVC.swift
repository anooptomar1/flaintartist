...
final class ChooseArtVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, TOCropViewControllerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: ChooseArtCell.self), for: indexPath) as? ChooseArtCell
    ...
    func crop() {
        ...
        var targetSize: CGSize {
            ...
            return CGSize(width: artImage.size.width * scale,  height: artImage.size.height * scale)
        }
...
extension ChooseArtVC: PHPhotoLibraryChangeObserver {
