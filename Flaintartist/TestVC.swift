...
//        
//        guard let object = boxNode, let cameraTransform = session.currentFrame?.camera.transform else {
//            return
//        }
//        
...
//        guard let object = boxNode, let planeAnchorNode = sceneView.node(for: anchor) else {
//            return
//        }
//        
...
//        
//        if boxNode != nil && sceneView.isNode(boxNode!, insideFrustumOf: sceneView.pointOfView!) {
//            focusSquare?.hide()
//        } else {
//            focusSquare?.unhide()
//        }
